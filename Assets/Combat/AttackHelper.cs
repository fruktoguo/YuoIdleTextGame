...
using YuoTools.UI;
using static YuoTools.UI.View_NumTipPanelComponent;
...
namespace AI
{
    public class AttackHelper
    {
        ...
        ///  造成治疗效果
        /// </summary>
        /// <param name="curer"></param>
        /// <param name="beCurer"></param>
        ...
        {
            YuoWorld.RunSystem<IOnAttackBeforeAnima>(attacker.Entity);
        }
