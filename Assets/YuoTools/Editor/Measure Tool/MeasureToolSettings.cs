...
namespace YuoTools.Editor
{
    ...
    public class MeasureToolSettings : ScriptableObject
    {
        ...
        [SerializeField] private ToolMode mode;
        [SerializeField] private ToolUnits unit;
        [SerializeField] private ToolScale scale;

        [SerializeField] private Color lineColor = Color.black;
        [SerializeField] private float handlesSize = 0.01f;
        [SerializeField] private Color handlesColor = Color.white;
        [SerializeField] private float textSize = 16f;
        ...
        public ToolUnits Unit => unit;

        public ToolScale Scale => scale;
