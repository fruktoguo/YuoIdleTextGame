    ...
    public class MeasureTool
    {
        ...
        private void DrawColliderMeasurement(GameObject gameObject)
        {
            ...
            if (settings.Scale == MeasureToolSettings.ToolScale.Local)
            {
                ...
                else if (col.GetType() == typeof(CapsuleCollider))
                {
                    ...
                    array = VerticesFromSize(capsuleCol.center,
                        new Vector3(capsuleCol.radius * 2f, capsuleCol.height, capsuleCol.radius * 2f));
                    TransformPoints(gameObject, array);
                }
        ...
        private void DrawCubeFromVectorArray(Vector3[] array, Transform attachedTransform)
        {
            ...
            if (attachedTransform != null)
            {
                ...
                diagonalOffset = (attachedTransform.right + attachedTransform.forward).normalized * settings.Offset *
                                 10f;
            }
            ...
            DrawHandle(array[3], array[0], -diagonalOffset, DistanceInUnits(Vector3.Distance(array[3], array[0])),
                Color.green);
        }
