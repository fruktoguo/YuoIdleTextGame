...
namespace YuoTools.Main.Ecs
{
    ...
    {
        public static bool CloseSystemTry;
        ...
        void RunSystem<T>(YuoEntity entity, Type componentType) where T : ISystemTag
        {
        ...
        void RunSystemOfBase<T>(YuoEntity entity, Type baseComponentType) where T : ISystemTag
        {
            if (GetSystemOfBaseComponent(baseComponentType, out var systems))
            {
                var runType = typeof(T);
