...
using RandomHelper = YuoTools.Main.Ecs.RandomHelper;
...
namespace ET
{
    ...
    public sealed class KService : AService
    {
        ...
        public uint TimeNow => (uint)(TimeInfo.Instance.ClientFrameTime() - this.startTime);
        ...
        private void Recv()
        {
            ...
            while (this.Transport != null && this.Transport.Available() > 0)
            {
                ...
                $"flag:{flag}__messageLength:{messageLength}".Log();
                ...
                try
                {
                    ...
                    switch (flag)
                    {
                        ...
                        case KcpProtocalType.RouterReconnectSYN:
                        {
                            ...
                            {
                                Log.Warning(
                                    $"kchannel reconnect not found channel: {localConn} {remoteConn} {realAddress}");
                                break;
                            }
                            ...
                            {
                                Log.Warning(
                                    $"kchannel reconnect localconn error: {localConn} {remoteConn} {realAddress} {kChannel.LocalConn}");
                                break;
                            }
                            ...
                            {
                                Log.Warning(
                                    $"kchannel reconnect remoteconn error: {localConn} {remoteConn} {realAddress} {kChannel.RemoteConn}");
                                break;
                            }
                        ...
                        case KcpProtocalType.SYN: // accept
                        {
                            ...
                            if (kChannel == null)
                            {
                                ...
                                localConn = RandomHelper.RandUInt32();
                                ...
                                IPEndPoint realEndPoint = kChannel.RealAddress == null
                                    ? kChannel.RemoteAddress
                            ...
                            {
                                Log.Error(
                                    $"kchannel syn address diff: {kChannel.Id} {kChannel.RealAddress} {realAddress}");
                                break;
                            }
                            ...
                            try
                            {
                                ...
                                buffer.WriteTo(5, kChannel.RemoteConn);
                                Log.Info(
                                    $"kservice syn: {kChannel.Id} {remoteConn} {localConn} {kChannel.RemoteAddress}");
                        ...
                        case KcpProtocalType.MSG: // 断开
                            ...
                            {
                                // 通知对方断开
                                this.Disconnect(localConn, remoteConn, ErrorCore.ERR_KcpNotFoundChannel,
                                    this.ipEndPoint, 1);
                                break;
                            }
